			...
			content: [
				{
					...
					content: [
															...
															content: [
																{
																	elem: 'label',
																	tag: 'label',
																	attrs: {'for': 'exchange-filter-native-language'},
																	content:
																		'Родной язык'
																},
																{
																	...
																	content: [
																		{
																			elem: 'select',
																			tag: 'select',
																			attrs: {'id': 'exchange-filter-native-language', 'name': 'exchange-filter-native-language'},
																			content: [
																				{
																					tag: 'option',
						...
						{
							block: 'filter-languages',
							content: [
								{
									block: 'filter-languages-list',
									tag: 'ul',
									content: [
										{
											flag: '1',
										...
										return {
											block: 'filter-languages-list-item',
											tag: 'li',
											content: [
												{
													elem: 'label',
													...
													content: [
														{
															elem: 'radio',
															tag: 'input',
															attrs: {'type': 'radio', 'name': 'exchange-filter-languages', 'id': 'exchange-filter-languages', 'value': item.name, 'checked': item.active ? '' : undefined}
														},
														{
															elem: 'info',
															content: [
